...
.card {
    border-radius: 5px;
    -webkit-box-shadow: 0 1px 20px 0 orange;
...
.bg-c-lite-green {
    ...
    background: linear-gradient(to right, #ecedea, #f77402)
}
         ...
         <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
             <?php
                ...
                $link=array("index.php","test.php","dash.php","gallery.php");
...
<div class="page-content page-container" id="page-content" style="margin-top: 5rem;">
    <div class="padding">
                    ...
                    <div class="row m-l-0 m-r-0">
                        <div class="col-sm-4 bg-c-lite-green user-profile">
                            <div class="card-block text-center text-white">
                                <div class="m-b-25"><img src="https://avatars.githubusercontent.com/u/71770879?s=460&u=2b363f174c196ad0a14ecb5a3a3dbe37550d952b&v=4" style='width: 120px; height:120px; border-radius: 50%;' class="img-radius" alt="User-Profile-Image"> </div>
                        ...
                        <div class="col-sm-8">
                            <div class="card-block">
                                <h6 class="m-b-20 p-b-5 b-b-default f-w-600">ID</h6>
                                <div class="row">
                                    <div class="col-sm-6">
